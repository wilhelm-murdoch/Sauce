<?php
	/**
	 * Exception for 'Gone' HTTP responses.
	 *
	 * @package Sauce
	 * @subpackage System/Classes/Exception/HTTP
	 * @author Daniel Wilhelm II Murdoch <wilhelm.murdoch@gmail.com>
	 */
	class Exception_HTTP_Gone extends Exception_Core {
		/**
		...
		public function __construct($message = null) {
			parent::__construct(Request::$responses[410].(is_null($message) === false ? ": {$message}" : ''), 410);
		}
	}